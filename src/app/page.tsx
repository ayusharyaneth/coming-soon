...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start p-[10px] relative overflow-x-hidden bg-[#050505] text-white selection:bg-primary/20">
      <ThreeBackground />
      ...
      <motion.nav
        ...
        className="relative z-10 mt-8 md:mt-12 flex items-center gap-4 mb-[70px]"
      >
      ...
      <main className="relative z-10 flex flex-col items-center text-center max-w-3xl w-full mb-8 justify-center">
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          ...
          className="text-zinc-400 text-sm md:text-lg max-w-lg leading-relaxed font-medium tracking-tight opacity-80 mb-12"
        >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center">
            ...
            >
              ...
              {/* GitHub */}
              <a href="#" className="group relative">
                <div className="absolute inset-0 rounded-2xl blur-xl opacity-0 group-hover:opacity-40 transition-opacity duration-500 bg-white"></div>
                <div className="relative w-14 h-14 md:w-16 md:h-16 flex items-center justify-center rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md transition-all duration-500 group-hover:border-transparent group-hover:bg-white group-hover:text-black">
                  <div className="transform transition-transform duration-500 group-hover:scale-110">
      ...
      <footer className="relative z-10 w-full mt-auto py-8">
